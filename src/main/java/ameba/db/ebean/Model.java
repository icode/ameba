...
public class Model {
    ...
    private Object _getId() {
        ...
        if (_idPublicField != null) {
            try {
                return _idPublicField.get(this);
        ...
        try {
            return _idGetSet.getReadMethod().invoke(this);
        } catch (RuntimeException e) {
            throw e;
        } catch (Exception e) {
            throw new RuntimeException(e);
    ...
    private void _setId(Object id) {
        ...
        try {
            _idGetSet.getWriteMethod().invoke(this, id);
        } catch (RuntimeException e) {
            throw e;
        } catch (Exception e) {
            throw new RuntimeException(e);
